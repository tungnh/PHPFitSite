                ...
                <div class="col-sm-12">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <form data-validate="parsley" class="form-horizontal" enctype="multipart/form-data" name="fmenu" method="post" action="{{ url('/admin/position/edit/'.$position_info->id) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="position_name" class="form-control"
                                               value="{{ $position_info->position_name }}"
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea cols="50" rows="3" class="form-control" name="description" id="description"
                                                  data-maxlength="500" data-maxlength-message="<b>Mô tả</b> không được vượt quá 500 ký tự" >{{ $position_info->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="order_number" class="form-control " 
                                               value="{{ $position_info->order_number }}"
