                ...
                <div class="col-sm-12">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <form data-validate="parsley" class="form-horizontal" enctype="multipart/form-data" name="fmenu" method="post" action="{{ url('/admin/slide/edit/'.$slide_info->id) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <input hidden name="avatar" id="avatar" value="{{ $slide_info->avatar }}" />
                                        <img src="{{ $slide_info->avatar }}" id="select_avatar" class="img-avatar"/>
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea cols="50" rows="3" class="form-control" name="description" id="description"
                                                  ...
                                                  data-maxlength="200" data-maxlength-message="<b>Mô tả</b> không được vượt quá 200 ký tự" >{{ $slide_info->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                    <label class="col-sm-2 control-label">Đường dẫn :</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="link" class="form-control" value="{{ $slide_info->link }}">
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="switch"><input type="checkbox" name="is_active" value="1" {{ $slide_info->is_active ? 'checked' : ''}} ><span></span></label>
                                    </div>
                                </div>
