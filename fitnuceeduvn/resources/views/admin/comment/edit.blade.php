                ...
                <div class="col-sm-12">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <form data-validate="parsley" class="form-horizontal" enctype="multipart/form-data" name="fcomment" method="post" action="{{ url('/admin/comment/edit/'.$comment_info->id) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea cols="50" rows="3" class="form-control" name="comments_content" id="comments_content"
                                                  data-required="true" data-required-message="<b>Nội dung</b> không được để trống">{{ $comment_info -> comments_content}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Trạng thái hiển thị</label>
                                    <div class="col-sm-10">
                                        <label class="switch"><input type="checkbox" name="is_active" value="1" {{ $comment_info->is_active ? 'checked' : '' }}><span></span></label>
                                    </div>
                                </div>
