                ...
                <div class="col-sm-12">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <form data-validate="parsley" class="form-horizontal" enctype="multipart/form-data" name="f_account" method="post" action="{{ url('/admin/account/edit/'.$account_info->id) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="switch"><input type="checkbox" name="is_active" value="1" {{ $account_info->is_active ? 'checked' : '' }}><span></span></label>
                                    </div>
                                </div>
