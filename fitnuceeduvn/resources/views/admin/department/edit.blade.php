                ...
                <div class="col-sm-12">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            <form data-validate="parsley" class="form-horizontal" enctype="multipart/form-data" name="fmenu" method="post" action="{{ url('/admin/department/edit/'.$department_info->id) }}">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-6">
                                        <select name="parent_id" class="form-control">
                                            ...
                                            @foreach($departments_parent as $department)
                                                <option value="{{ $department->id }}" {{ $department->id == $department_info->id ? 'selected' : '' }}>{{ $department->department_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-b-xs">
                                    <label class="col-sm-2 control-label">Số điện thoại <font color="red">*</font>:</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="phone" class="form-control"
                                               value="{{ $department_info->phone}}"
                                ...
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea cols="50" rows="3" class="form-control" name="address" id="address">{{ $department_info->address}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                    <label class="col-sm-2 control-label">Mô tả :</label>
                                    <div class="col-lg-6">
                                        <textarea cols="50" rows="3" class="form-control" name="description" id="description">{{ $department_info->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group m-b-xs">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="order_number" class="form-control " 
                                               value="{{ $department_info->order_number}}"
